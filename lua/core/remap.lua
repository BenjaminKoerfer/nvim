...
vim.keymap.set("n", "<leader>sg", "<cmd>Rg<CR>", { desc = "[s]earch [g]rep" })
vim.keymap.set("n", "<leader><leader>", "<cmd>Buffers<CR>", { desc = "search Buffers" })
-- vim.keymap.set("n", "<leader>sf", "<cmd>Files<CR>", { desc = "[s]earch [f]iles" })
vim.keymap.set("n", "<leader>sc", "<cmd>Commits<CR>", { desc = "[s]earch [c]ommits" })
vim.keymap.set("n", "<leader>sG", "<cmd>GFiles<CR>", { desc = "[s]earch [G]it" })
